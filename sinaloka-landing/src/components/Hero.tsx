...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-accent-950 min-h-[100svh]">
      ...
      {/* Gradient orbs */}
      <div className="absolute top-[-15%] right-[10%] w-[600px] h-[600px] rounded-full bg-accent-600/20 blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-20%] left-[-5%] w-[500px] h-[500px] rounded-full bg-accent-400/12 blur-[120px] pointer-events-none" />
      <div className="absolute top-[40%] left-[30%] w-[300px] h-[300px] rounded-full bg-accent-500/8 blur-[100px] pointer-events-none" />

      {/* Subtle diagonal line accent */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[200px] -right-[100px] w-[1px] h-[800px] bg-gradient-to-b from-transparent via-accent-400/20 to-transparent rotate-[25deg]" />
        <div className="absolute top-[100px] -right-[200px] w-[1px] h-[600px] bg-gradient-to-b from-transparent via-accent-300/10 to-transparent rotate-[25deg]" />
      </div>

      {/* ── Content ── */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-28 lg:pt-36 pb-16 lg:pb-20">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16 xl:gap-20">
          {/* Left — Text content */}
          <div className="lg:w-[45%] xl:w-[42%] shrink-0 mb-12 lg:mb-0">
            <motion.div
            ...
            <motion.h1
              ...
              className="text-[clamp(2.5rem,5vw,3.75rem)] font-extrabold leading-[1.08] tracking-tight text-white"
            >
              Ngurusin bimbel
              <br />
              <span className="text-accent-400">nggak harus</span>
              <br />
              ribet.
            </motion.h1>
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: `0 ${20 + tilt.x * 4}px 80px -15px rgba(0,0,0,0.4), 0 ${10 + tilt.x * 2}px 40px -8px rgba(13,148,136,0.15), 0 0 0 1px rgba(255,255,255,0.05)`,
              }}
            >
              {/* Browser chrome */}
              ...
              <div className="flex">
                ...
                <div className="hidden sm:block w-44 bg-[#FAFAFA] border-r border-[#F0F0F0] p-3 shrink-0">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-[8px] font-semibold text-[#BBB] uppercase tracking-wider px-2 mb-1">
                      General
                    </div>
                    ...
                    <div className="text-[8px] font-semibold text-[#BBB] uppercase tracking-wider px-2 mt-3 mb-1">
                      Academics
                    </div>
                    {["Siswa", "Tutor", "Kelas"].map((item) => (
                      <div
                        key={item}
                        className="flex items-center gap-2 px-2 py-1.5 rounded-md text-[#999] hover:bg-[#F0F0F0]"
                      >
                    ...
                    {["Jadwal", "Absensi"].map((item) => (
                      <div
                        key={item}
                        className="flex items-center gap-2 px-2 py-1.5 rounded-md text-[#999]"
                      >
                        <div className="w-3 h-3 rounded bg-[#E5E5E5]" />
                        <span className="text-[9px]">{item}</span>
                      </div>
                ...
                <div className="flex-1 p-4 sm:p-5 bg-white min-h-[280px] sm:min-h-[340px]">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="w-6 h-6 rounded-full bg-accent-100 flex items-center justify-center">
                        <span className="text-[8px] font-bold text-accent-700">
                          A
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="grid sm:grid-cols-[1.5fr,1fr] gap-3">
                    ...
                    <div className="rounded-lg border border-[#F0F0F0] p-3">
                      <div className="text-[10px] font-semibold text-[#111] mb-2">
                        Aktivitas Terbaru
                      </div>
                      <div className="space-y-2">
                        {[
                          {
                            text: "Rina membayar SPP Maret",
                            time: "2 min",
                            dot: "bg-emerald-400",
                          },
                          {
                            text: "Kelas Matematika dimulai",
                            time: "15 min",
                            dot: "bg-blue-400",
                          },
                          {
                            text: "Tutor baru: Pak Ahmad",
                            time: "1 jam",
                            dot: "bg-violet-400",
                          },
                          {
                            text: "Absensi Fisika tercatat",
                            time: "2 jam",
                            dot: "bg-amber-400",
                          },
                        ].map((item) => (
                          ...
                          >
                            ...
                            />
                            <span className="text-[9px] text-[#444] flex-1 truncate">
                              {item.text}
                            </span>
                            <span className="text-[8px] text-[#BBB] shrink-0">
                              {item.time}
                            </span>
                          </div>
                        ))}
      ...
      {/* Clean bottom edge — no gradient, just the dark ending naturally */}
    </section>
  );
}
