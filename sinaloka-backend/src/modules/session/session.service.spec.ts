...
describe('SessionService', () => {
  ...
  describe('update', () => {
    it('should update a session', async () => {
      ...
      mockPrisma.session.findFirst.mockResolvedValue(existing);
  ...
  describe('generateSessions', () => {
    it('should generate sessions for matching schedule days in date range', async () => {
      ...
      mockPrisma.class.findFirst.mockResolvedValue(classRecord);
  ...
  describe('completeSession (tutor)', () => {
    it('should skip payout creation when duplicate payout exists', async () => {
      ...
      mockPrisma.class.findFirst.mockResolvedValue(classForFee);
